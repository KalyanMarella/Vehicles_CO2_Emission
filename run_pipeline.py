...
from pipelines.inference_pipeline import inference_co2_emission

# from pipelines.inference_pipeline impor
from pipelines.training_pipeline import training_co2_emission
